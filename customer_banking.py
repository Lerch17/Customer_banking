...
def main():
    ...
    savings_maturity = int(input('what is the length of months for you savings? '))
    ...
    print(f"the balance is: $, {updated_savings_balance: ,.2f}" )
    print(f"APR Interest Rate is:, {interest_earned: ,.2f}, %")
    ...
    print(f'The balance is: $, {updated_cd_balance: ,.2f}')
    print(f"APR Interest Rate is:, {interest_earned: ,.2f}, %")
